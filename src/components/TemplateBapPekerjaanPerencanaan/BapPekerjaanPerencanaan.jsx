...
import BapPekerjaanPerencananPreview from "./BapPekerjaanPerencanaanPreview";
...
const BapPekerjaanPerencanaan = ({ documentId, projectDetailData, currFileType }, ref) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        if (documentId) {
          const response = await axios.get(`${process.env.REACT_APP_BASE_URL}/dynamic/crud/get_by_id/berita_acara_serah_terima_pekerjaan_perencanaan?id=${documentId}`);
    ...
    if (documentId) {
      try {
        const response = await axios.put(
          `${process.env.REACT_APP_BASE_URL}/dynamic/crud/put/berita_acara_serah_terima_pekerjaan_perencanaan?id=${documentId}`,
          {
            ...
            waktu_mulai: formData.waktu_mulai ? format(formData.waktu_mulai, "yyyy-MM-dd") : null,
            waktu_selesai: formData.waktu_selesai ? format(formData.waktu_selesai, "yyyy-MM-dd") : null,
          },
      ...
      try {
        const response = await axios.post(
          `${process.env.REACT_APP_BASE_URL}/dynamic/crud/post/berita_acara_serah_terima_pekerjaan_perencanaan`,
          {
            project_id: projectDetailData.id,
            nomor_surat_berita_acara: formData.nomor_bap_serahterima,
            tanggal_surat_berita_acara: formData.tanggal_bap_serahterima ? format(formData.tanggal_bap_serahterima, "yyyy-MM-dd") : null,
          ...
          {currFileType !== "word" && (
            <>
              ...
              <div className="paragraf-text-justify">
                ...
                , dengan ini telah setuju dan sepakat untuk melakukan Serah Terima Pekerjaan <strong>PERENCANAAN</strong> dengan ketentuan sebagai berikut : <strong> PIHAK KEDUA</strong> menyerahkan kepada <strong>PIHAK KESATU</strong> dan{" "}
              ...
              <div className="paragraf-text-justify">
                Demikian berita acara Serah Terima Pekerjaan Perencanaan ini dibuat dan ditanda tangani di {projectDetailData.tempat_ttd} pada tanggal tersebut diatas dalam secukupnya untuk dapat dipergunakan sebagaimana mestinya.
              </div>
  ...
  useImperativeHandle(ref, () => ({
    handleDownload: async (fileType) => {
      ...
      const filename = "bap_pekerjaan_perencanaan";
      ...
      <div className="main-form-container">
        ...
        <div className="form-container">
          <div className="position-absolute">
            {" "}
            {isSuccessModalOpen && <SuccessModal onClose={() => setIsSuccessModalOpen(false)} docName={"BAP Pekerjaan Perencanaan"} />}
            {isFailedModalOpen && <FailedModal onClose={() => setIsFailedModalOpen(false)} docName={"BAP Pekerjaan Perencanaan"} />}
          </div>
        ...
        {/* <BapPekerjaanPerencanaanWord /> */}
        <ComponentWord />
        <BapPekerjaanPerencananPreview formDataPreview={formData} dataProjectDetail={projectDetailData} />
      </div>
...
export default forwardRef(BapPekerjaanPerencanaan);
