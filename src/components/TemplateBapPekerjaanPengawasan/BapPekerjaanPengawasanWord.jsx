...
const BapPekerjaanPengawasanWord = ({ formDataPreview, dataProjectDetail }) => {
  return (
    <>
      <div className="preview-layout">
        ...
        <div class="a4-container-bastperencanaan">
            ...
            <table className="custom-table-header">
              <tbody>
                <tr>
                  ...
                  <td>
                    <div className="surat-header-bap-perencanaan-text-bold-right">BERITA ACARA SERAH TERIMA PEKERJAAN PENGAWASAN</div>
                  </td>
                </tr>
                <tr>
                  <td>
          ...
          <div className="paragraf-text-justify">
            Demikian berita acara Serah Terima Pekerjaan Pengawasan ini dibuat dan ditanda tangani di Bengkulu pada tanggal tersebut diatas dalam secukupnya untuk dapat dipergunakan sebagaimana mestinya.
          </div>
...
export default BapPekerjaanPengawasanWord;
