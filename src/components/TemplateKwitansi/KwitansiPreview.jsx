import "./KwitansiUI.css";

const KwitansiPreview = ({ previewFormData, detailDataProject }) => {
  return (
      ...
      <div className="a4-container-kwitansi-ui">
        <div className="kwitansi-content-ui">
          ...
          <div className="kwitansi-detail-container-ui">
            ...
            <span className="label-detail-kwitansi-ui">Sumber Dana</span>
            <span className="separator-detail-kwitansi-ui">:</span>
            <span className="value-detail-kwitansi-ui">
            ...
            <span className="label-detail-kwitansi-ui">Nomor Addendum</span>
            <span className="separator-detail-kwitansi-ui">:</span>
            <span className="value-detail-kwitansi-ui">
              Nomor <span className="separator-detail-kwitansi-ui">:</span>{" "}
              <span style={{ color: "red" }}>
